  ...
  return (
    <footer className="relative z-0 mt-16 w-full overflow-hidden border-t border-white/5 bg-black pb-10 pt-12 text-white font-body">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="pointer-events-none mt-10 sm:mt-16 md:mt-24 w-full select-none text-center overflow-hidden">
        ...
        <div className="mt-6 w-full border-t border-white/5 pb-4 pt-6 sm:mt-12 md:mt-16">
          <div className="flex flex-col items-center justify-between gap-5 md:flex-row md:gap-0">
            <p className="font-body text-center text-[10px] font-medium tracking-normal text-white/40 sm:text-[13px] md:text-left">
              © 2026 {siteTitle}. All rights reserved.
            </p>

            <div className="flex items-center justify-center gap-6 sm:gap-8">
              <Link href="/privacy-policy" className="text-[9px] font-bold uppercase tracking-[0.1em] text-white/30 transition-all hover:text-white sm:text-[10px]">
                Privacy Policy
              </Link>
              <Link href="/terms-of-service" className="text-[9px] font-bold uppercase tracking-[0.1em] text-white/30 transition-all hover:text-white sm:text-[10px]">
                Terms of Service
              </Link>
            </div>
          </div>
